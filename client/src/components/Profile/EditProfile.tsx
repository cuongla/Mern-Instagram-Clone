...
const EditProfile: React.FC<EditProfileProps> = ({ setOnEdit }) => {
    const initState: EditProfileData = {
        fullname: '',
        mobile: '',
        address: '',
        website: '',
    ...
    const changeAvatar = (e: ChangeEvent<HTMLInputElement>): void => {
        ...
        const err: string = checkImage(file);
    ...
    const handleInput = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>): void => {
